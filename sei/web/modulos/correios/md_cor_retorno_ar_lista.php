        ...
        <div class="row linha">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <label id="lblCodRastreamento" for="txtCodRastreamento" class="infraLabelOpcional">
                            Rastreamento:</label><br/>
                        <input type="text" id="txtCodRastreamento" name="txtCodRastreamento"
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <input type="text" id="numProcesso" name="numProcesso" class="infraText form-control"
                               value="<?= PaginaSEI::tratarHTML($_POST['numProcesso']) ?>" maxlength="250"
                               tabindex="503">
                    </div>
                    <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                        <label id="lblPeriodoProcessamento" for="txtPeriodoProcessamentoInicio" accesskey="o"
                               class="infraLabelOpcional">Período do Processamento:</label><br/>
                        <div class="input-group mb-3" style="padding-top: 0px">
                            <input type="text"
                                   onkeypress="return infraMascara(this, event,'##/##/####')"
                                   id="txtPeriodoProcessamentoInicio"
                                   name="txtPeriodoProcessamentoInicio"
                                   class="infraText"
                            ...
                            <label id="lblAte" class="infraLabelOpcional">a</label>
                            <input
                                    type="text"
                                    onkeypress="return infraMascara(this, event,'##/##/####')"
