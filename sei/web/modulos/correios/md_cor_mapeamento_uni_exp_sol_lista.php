...
if ($numRegistros > 0) {
    $strResultado .= '<table width="99%" class="infraTable" summary="Mapeamento de Unidades Solicitantes">';
    ...
    $strResultado .= '<th class="infraTh" width="auto">' . PaginaSEI::getInstance()->getThOrdenacao($objMdCorMapeamentoUniExpSolDTO, 'Unidade Expedidora', 'SiglaUnidadeExpedidora', $arrObjMdCorSerieExpDTO) . '</th>';
    $strResultado .= '<th class="infraTh" width="auto">' . PaginaSEI::getInstance()->getThOrdenacao($objMdCorMapeamentoUniExpSolDTO, 'Unidade Solicitante', 'SiglaUnidadeSolicitante', $arrObjMdCorSerieExpDTO) . '</th>';
...
?>
    <form id="frmMdCorUnidadeExpCadastro" method="post"
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <label id="lblUnidadeExpedidora" for="selUnidadeExpedidora" class="infraLabelOpcional">Unidades
                            Expedidoras:</label>
                        <select onchange="pesquisar()" id="selUnidadeExpedidora" name="selUnidadeExpedidora"
                                class="infraSelect form-control"
                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>" <?= $strDesabilitar; ?>>
                            <?= $strItensSelUnidade ?>
                        </select>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <label id="lblUnidadeSolicitante" for="selUnidadeSolicitante" class="infraLabelOpcional">Unidades
                            Solicitantes:</label>
                        <select onchange="pesquisar()" id="selUnidadeSolicitante" name="selUnidadeSolicitante"
                                class="infraSelect form-control"
                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>" <?= $strDesabilitar; ?>>
