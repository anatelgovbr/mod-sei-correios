 ...
 */
  ...
  //$objMdCorExpedicaoSolicitadaDTO->retStrObservacao();
 ...
 */    }else{
    ...
    */
    ...
    //$strResultado .= '<th class="infraTh">'.PaginaSEI::getInstance()->getThOrdenacao($objMdCorExpedicaoSolicitadaDTO,'','Observacao',$arrObjMdCorExpedicaoSolicitadaDTO).'</th>'."\n";
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      //$strResultado .= '<td>'.PaginaSEI::tratarHTML($arrObjMdCorExpedicaoSolicitadaDTO[$i]->getStrObservacao()).'</td>';
