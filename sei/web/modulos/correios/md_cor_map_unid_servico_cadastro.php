                ...
                if ($numRegistros > 0) {
                    for ($i = 0; $i < $numRegistros; $i++) {
                        $arrItensTabelaContratoServicos[] = array($arrObjMdCorMapUnidServicosDTO[$i]->getNumIdMdCorServicoPostal(),
                            ...
                            //,
                            //'<img src="/infra_css/imagens/remover.gif" title="Remover Item" class="infraImg" style="width: 16px; height: 16px;">'
                        );
                    }
                }
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                        <label id="lblDescricao" for="txtDescricao" accesskey="q" class="infraLabelObrigatorio">Unidade
                            Solicitante:</label>
                        <input type="text" id="txtUnidade" name="txtUnidade" class="infraText form-control"
                               tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>" <?= $strDesabilitar . $strDesabilitarConsultar ?>/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div class="input-group mb-3">
                            <select id="selUnidades" name="selUnidades" size="4" multiple="multiple"
                                    class="infraSelect"<?= $strDesabilitar . $strDesabilitarConsultar ?>>
                                <?= $strItensSelUnidades ?>
                            </select>
                        ...
                        <input type="hidden" id="hdnIdUnidade" name="hdnIdUnidade"
                               value="<?= $_POST['hdnIdUnidade'] ?>"/>
                        <input type="hidden" id="hdnIdUnidadeSolicitante" name="hdnIdUnidadeSolicitante"
                               value="<?= $objMdCorMapUnidServicoDTO->getNumIdUnidadeSolicitante(); ?>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <fieldset id="fieldsetDocInstaurador" class="infraFieldset form-control">
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                                    ...
                                    <select tabindex="504" name="selContrato" class="infraSelect form-control"
                                            id="selContrato"<?= $strDesabilitarConsultar ?>>
                                        <?= $strItensSelContrato ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                    <label id="lblIDNCondutas" class="infraLabelObrigatorio classDispositivoNormativo"
                                           for="selServicos">Serviços Postais:</label>
                                    <div class="input-group mb-3">
                                        <select id="selServicos" name="selServicos" multiple rows=7 class="infraSelect"
                                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"<?= $strDesabilitarConsultar ?>>
                                            <? //=$strItensSelServicos ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <table id="tbContratoServicos" class="infraTable" width="100%" align="left"
                                           summary="Lista de Processos a serem Sobrestados">
                                        <tr>
                                            <th class="infraTh" style="display: none;">ID Servico</th>
                                            <th class="infraTh" id="tdNumeroProcessoContratoServicos" width="30%"
                                                align="center">
                                                Número
                                                do Contrato no Órgão
                                            </th>
                                            <th class="infraTh" id="tdNumeroProcessoTipoContratoServicos" width="40%"
                                                align="center">
                                                Número do Contrato nos Correios
                                            </th>
                                            <th class="infraTh" id="tdDtSobrestamentoContratoServicos" width="10%"
                                                align="center">
                                                Serviços Postais
                                            </th>
