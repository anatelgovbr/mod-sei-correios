        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <label id="lblCodigoStatusSro" for="txtCodigoStatusSro" accesskey="" class="infraLabelObrigatorio">Código
                        Situação SRO:</label><br/>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <label id="lblDescricaoSRO" for="txtDescricaoSRO" class="infraLabelObrigatorio">Descrição
                        SRO:</label></br>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <label id="lblImagem" for="selImagem" class="infraLabelObrigatorio">Situação no Rastreio do
                        Módulo:</label></br>
