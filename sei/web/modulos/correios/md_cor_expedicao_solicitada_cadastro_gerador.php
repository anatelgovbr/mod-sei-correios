...
try {
  ...
  switch($_GET['acao']){
    case 'md_cor_expedicao_solicitada_cadastrar':
      ...
      $objMdCorExpedicaoSolicitadaDTO->setStrObservacao($_POST['txtObservacao']);
...
PaginaSEI::getInstance()->abrirAreaDados('4.5em');
?>
  <label id="lblObservacao" for="txtObservacao" accesskey="" class="infraLabelOpcional">observacao:</label>
  <input type="text" id="txtObservacao" name="txtObservacao" class="infraText" value="<?=PaginaSEI::tratarHTML($objMdCorExpedicaoSolicitadaDTO->getStrObservacao());?>" onkeypress="return infraMascaraTexto(this,event,250);" maxlength="250" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
<?
PaginaSEI::getInstance()->fecharAreaDados();
PaginaSEI::getInstance()->abrirAreaDados('4.5em');
?>
