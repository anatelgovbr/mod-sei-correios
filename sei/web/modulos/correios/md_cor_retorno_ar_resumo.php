    ...
    switch ($_GET['acao']) {
        case 'md_cor_retorno_ar_resumir':
            ...
            foreach ($arrLabelStatus as $status => $quantidade) {
                ...
                $strResultado .= '</td>';
                $strResultado .= '<td>';
                $strResultado .= '<a style="cursor: pointer" onclick="abrirResumoProcessamento(\'' . $urlResumo . '\')"> <img src="modulos/correios/imagens/associar.png" title="Listar Dados do Processamento" alt="Listar Dados do Processamento" class="infraImg" /> </a>';
