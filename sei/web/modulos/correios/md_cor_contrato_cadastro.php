        ...
        if (isset($_GET['id_md_cor_contrato'])) {
            ...
            foreach ($arrObjMdCorServicoPostalDTO as $i => $objMdCorServicoPostalDTO) {
                ...
                $itensTabelaContratoServicos = array(
                    ...
                    '<label><select class="infraSelect sl_tipo form-control" id="sl_tipo" name="sl_tipo[' . $i . ']"  onchange="verificaAr(this)">' . json_encode($mdCorTipoCorrespondencia) . '</select></label>',
                    $strRd,
                    $strChk,
                    '<input type="text" class="input-desc form-control" name="descricao[' . $i . ']" value="' . PaginaSEI::tratarHTML($objMdCorServicoPostalDTO->getStrDescricao()) . '" ' . $readonly . '/><input type="hidden" name="id[' . $i . ']" value="' . $objMdCorServicoPostalDTO->getStrIdWsCorreios() . '"><input class="input-desc" type="hidden" name="codigo[' . $i . ']" value="' . $objMdCorServicoPostalDTO->getStrCodigoWsCorreios() . '"><input class="input-desc" type="hidden" name="nome[' . $i . ']" value="' . $objMdCorServicoPostalDTO->getStrNome() . '">',
                    ''
                );
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <fieldset id="fieldsetContratoOrgao" class="infraFieldset form-control" style="height: 100%">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5"" id="divLblTipoProcessoContratacao">
                            <? if ($_GET['acao'] == 'md_cor_contrato_cadastrar' || $_GET['acao'] == 'md_cor_contrato_alterar') { ?>
                                <label id="lblTipoProcessoContratacao" class="infraLabelOpcional"
                                       for="txtDtInstauracao"><?= $strTipoProtocolo; ?></label>
                            <? } ?>
                        </div>
                            ...
                            <div style=" float: left; width: 100%;">
                                ...
                                <table id="tbContratoServicos" class="infraTable" width="100%" align="left"
                                    ...
                                    <tr>
                                        ...
                                        <th class="infraTh" width="" id="tdDescricaoServicoPostal" width="30%">Serviço Postal</th>
                                        <th class="infraTh" width="20%" align="center" id="tdCheckExpedidoAR">Tipo</th>
                                        <th class="infraTh" width="120px" align="center" id="tdCheckExpedidoAR">Expedido com AR</th>
                                        <th class="infraTh" width="80px" align="center" id="tdCheckCobrar">Serviço à Cobrar</th>
                                        <th class="infraTh" width="30%" id="tdTxtDescricao">Descrição Amigável</th>
