...
?>
    <form id="frmMdCorParametroCadastro" method="post" action="<?= SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao']) ?>">
        ...
        <div class="row">
            <div class="col-sm-8 col-md-8 col-lg-7 col-xl-6">
                <div class="form-group">
                    <label for="txtNuDiaRetorno" class="infraLabelObrigatorio lblCampo">
                        Prazo em dias para Retorno de AR:
                        <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Prazo Contratual para que o retorno do AR, em dias, seja considerado atrazado e a partir daí ser listado na página de ARs Pendentes de Retorno.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                    </label>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-8 col-lg-7 col-xl-6">
                <div class="form-group">
                    <label for="txtNuDiCobranca" class="infraLabelObrigatorio lblCampo">
                        Prazo em dias para Cobrança:
                        <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Prazo Contratual de AR, em dias,  não retornado e que ainda será possível a realização de uma cobrança.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                    </label>
                    <input type="text" id="txtNuDiCobranca" name="txtNuDiCobranca" class="infraText form-control" value="<?= !is_null($arrObjMdCorParametroArDTO) ? PaginaSEI::tratarHTML($arrObjMdCorParametroArDTO->getStrNuDiasCobrancaAr()) : null; ?>" onkeypress="return infraMascaraNumero(this,event,4);" maxlength="4" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-8 col-md-8 col-lg-7 col-xl-6">
                <div class="form-group">
                    <label id="lblNuLimiteDiasRetorno" for="lblNuLimiteDiasRetorno" class="infraLabelObrigatorio lblCampo">
                        ...
                        <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Prazo para Finalizar Fluxo do AR quando não retornado no prazo determinado, em Dias.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                    </label>
            ...
            <div class="col-12">
                <fieldset class="infraFieldset form-control mb-3 py-3">
                        ...
                        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label id="lblTipoDocumento" for="slTipoDocumento" class="infraLabelObrigatorio lblCampo">
                                    Tipo de Documento:
                                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Tipo de Documento Padrão que será utilizado quando o AR for retornado.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label for="slTipoConferencia" class="infraLabelObrigatorio">
                                    Tipo de Conferência: 
                                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Tipo de Conferência Padrão que será utilizado quando o AR for retornado.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
            ...
            <div class="col-12">
                <fieldset class="infraFieldset form-control mb-3 py-3">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label for="txtMotivo" class="infraLabelObrigatorio lblCampo">
                                    Motivo de Devolução:
                                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Inserir texto do Motivo de Devolução de Objeto que deseja Adicionar.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
            ...
            <div class="col-12">
                <fieldset class="infraFieldset form-control mb-3 py-3">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label for="slTipoDocumentoObjetoDevolvido" class="infraLabelObrigatorio lblCampo">
                                    Tipo de Documento:
                                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Tipo de Documento Padrão que será utilizado quando o Objeto for devolvido.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
                                <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label for="txtNoArvoreDevolvido" class="infraLabelObrigatorio lblCampo">
                                    Número/Nome na Árvore: 
                                    <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Complemento do Documento Padrão que será utilizado quando o Objeto for devolvido. \n \n Utilize a variável @tipo_doc_principal_expedido@ para apresentar o Tipo do Documento Principal e @numero@ para apresentar o Número SEI desse Documento Principal.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label for="slTipoConferenciaObjetoDevolvido" class="infraLabelObrigatorio">
                                    Tipo de Conferência: 
                                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Tipo de Conferência Padrão que será utilizado quando o Objeto for devolvido.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
                        ...
                        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label id="lblDestinatarios" for="txtDestinatario"
                                    ...
                                    <img align="top" src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg" onmouseover="return infraTooltipMostrar('Indique o Destinatário Padrão do Documento de Cobrança.', 'Ajuda');" onmouseout="return infraTooltipOcultar();" alt="Ajuda" class="infraImg">
                                </label>
