        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="row">
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <label id="lblUnidadeExpedidora" for="selUnidadeExpedidora" class="infraLabelObrigatorio">Unidades
                        Expedidoras:</label>
            ...
            <div class="row">
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <label id="lblUnidadeSolicitante" for="txtUnidadeSolicitante" class="infraLabelObrigatorio">Unidades
                        Solicitantes:</label>
                    <input type="text" id="txtUnidadeSolicitante" name="txtUnidadeSolicitante"
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="input-group mb-3">
                        <select id="selUnidadeSolicitante" name="selUnidadeSolicitante" size="10"
                                multiple="multiple"
