...
if($numRegistro > 0) {
    ...
    for ($i = 0; $i < $numRegistro; $i++) {
        ...
        switch ($objMdCorExpedicaoFomato[$i]->getStrImpressao()) {
            case 'P':
                $strObjTr .= '<td style="text-align: center"><img src="modulos/correios/imagens/png/impressao.png" class="infraImgAcoes"></td>';
                break;
            case 'C':
                $strObjTr .= '<td style="text-align: center"><img src="modulos/correios/imagens/png/impressao_color.png" class="infraImgAcoes"></td>';
                break;
            case 'G':
                $strObjTr .= '<td style="text-align: center"><img src="modulos/correios/imagens/png/midia.png" class="infraImgAcoes" ></td>';
                break;
        }
        $strObjTr .= '<td>' . $objMdCorExpedicaoFomato[$i]->getStrJustificativa() . '</td>';

        if ($objMdCorExpedicaoFomato[$i]->getStrFormaExpedicao() === 'I')
            $strObjTr .= '<td style="text-align: center"><a><img src="modulos/correios/imagens/impressora.png"></a> <a><img src="modulos/correios/imagens/imp_ar.png"></a> <a><img src="modulos/correios/imagens/imp_re.png"></a></td>';
        else
            $strObjTr .= '<td style="text-align: center"><a><img src="modulos/correios/imagens/download.png" ></a> <a><img src="modulos/correios/imagens/imp_ar.png"></a> <a><img src="modulos/correios/imagens/imp_re.png"></a></td>';
