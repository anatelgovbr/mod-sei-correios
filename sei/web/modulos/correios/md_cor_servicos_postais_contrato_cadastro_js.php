<script type="text/javascript">
    ...
    <? require_once('md_cor_servicos_postais_contrato_cadastro_inicializacao.php');?>
    ...
    function inicializar() {
        ...
        objTabelaContratoServicos = new infraTabelaDinamica('tbContratoServicos', 'hdnListaContratoServicosIndicados', false, true, false);
