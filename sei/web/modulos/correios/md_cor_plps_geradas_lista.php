...
try {
    ...
    if ($numRegistros > 0) {
        ...
        $strResultado .= '<th class="infraTh">' . PaginaSEI::getInstance()->getThOrdenacao($objMdCorPlpDTO, 'Objetos', 'Contagem', $arrObjMdCorPlpDTO) . '</th>' . "\n";
...
?>
<form id="frmPlpsGeradas" method="post"
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="row">
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    ...
                    <input type="text" id="txtCodigoPlp" name="txtCodigoPlp" class="infraText form-control"
                           value="<?= PaginaSEI::tratarHTML($_POST['txtCodigoPlp']) ?>"
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    ...
                    <input type="text" id="txtCodRastreamento" name="txtCodRastreamento" class="infraText form-control"
                           value="<?= PaginaSEI::tratarHTML($_POST['txtCodRastreamento']) ?>" maxlength="250"
                           tabindex="503">
                </div>
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <label id="lblNumDocumentoPrincipal" for="numDocumentoPrincipal" class="infraLabelOpcional">Documento
                        Principal:</label>
                    <input type="text" id="numDocumentoPrincipal" name="numDocumentoPrincipal"
                           class="infraText form-control"
                           value="<?= PaginaSEI::tratarHTML($_POST['numDocumentoPrincipal']) ?>" maxlength="250"
                           tabindex="503">
                </div>
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <label id="lblNumProcesso" for="numProcesso" class="infraLabelOpcional">Processo:</label>
                    <input type="text" id="numProcesso" name="numProcesso" class="infraText form-control"
                           value="<?= PaginaSEI::tratarHTML($_POST['numProcesso']) ?>" maxlength="250" tabindex="503">
                </div>
                <?php if ($_GET['acao'] != 'md_cor_expedicao_plp_listar') { ?>
                    <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <select id="txtStatus" name="txtStatus" class="infraSelect form-control"
                                maxlength="250"
                                tabindex="503">
                            <?= $strComboStatus ?>
                        </select>
