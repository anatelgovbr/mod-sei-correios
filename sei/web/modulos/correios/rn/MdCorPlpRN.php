...
//      }
    ...
    /**
     * Conclui a expedição da PLP: altera o status da PLP, lança o andamento de expedição em
     * cada processo e grava a data de expedição de cada solicitação.
     *
     * Método Controlado (transacional) de propósito: se o laço falhar no meio, o status da PLP
     * não pode ficar gravado sem a data de expedição das solicitações, senão essas solicitações
     * deixam de bloquear a conclusão do processo por AR pendente.
     *
