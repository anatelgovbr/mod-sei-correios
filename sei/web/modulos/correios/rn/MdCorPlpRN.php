      ...
      try {
        ...
        foreach ($ret as $key => $item) {
          ...
          if (isset($_POST['numProcesso']) && $_POST['numProcesso'] != "") {
            $objMdCorExpedicaoSolicitadaDTO->setStrProtocoloFormatado($_POST['numProcesso']);
          }
          if (isset($_POST['numDocumentoPrincipal']) && $_POST['numDocumentoPrincipal'] != "") {
            $objMdCorExpedicaoSolicitadaDTO->setStrProtocoloFormatadoDocumento($_POST['numDocumentoPrincipal']);
          }
          if (isset($_POST['txtCodRastreamento']) && !empty($_POST['txtCodRastreamento'])) {
            $objMdCorExpedicaoSolicitadaDTO->setStrCodigoRastreamento('%' . $_POST['txtCodRastreamento'] . '%', InfraDTO::$OPER_LIKE);
          }
