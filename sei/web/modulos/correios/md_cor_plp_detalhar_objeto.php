        ...
        for ($i = 0; $i < $numRegistros; $i++) {
            ...
            if ($arrObjMdCorExpedicaoFormatoDTO[$i]->getStrFormaExpedicao() == MdCorExpedicaoFormatoRN::$TP_FORMATO_IMPRESSO) {
                if ($arrObjMdCorExpedicaoFormatoDTO[$i]->getStrImpressao() == MdCorExpedicaoFormatoRN::$TP_IMPRESSAO_PRETO_BRANCO) {
                    $imgImpressao = 'impressao_preto_branco.png';
                    $title = 'Preto e Branco';
                } else {
                    $imgImpressao = 'impressao_colorida.png';
                    $title = 'Colorido';
                }
            } else {
                $imgImpressao = 'gravacao_midia.png';
                $title = 'Mídia';
            }
            ...
            $strResultado .= '<td style="word-break:break-all;text-align:center;"><div style="float:left;"><img src="modulos/correios/imagens/png/' . $imgImpressao . '" title="' . $title . '" alt="' . $title . '" class="infraImgAcoes" /></div></td>';
            ...
            if ($arrObjMdCorExpedicaoFormatoDTO[$i]->getStrFormaExpedicao() == MdCorExpedicaoFormatoRN::$TP_FORMATO_IMPRESSO) {
                ...
                $strResultado .= '<a onclick="javascript:validarAcesso( '.$bolDocumentoRestrito.', '."'$strUrl'".' )" tabindex="' . PaginaSEI::getInstance()->getProxTabTabela() . '">
                                    <img   src="modulos/correios/imagens/png/impressora.png" title="Impressão de documento" alt="Impressão de documento" class="infraImgAcoes" />
                                  </a>&nbsp;';
            } else {
                ...
                if($verificaProtocolo === false){
                    ...
                    $strResultado .= '<a  onclick="javascript:validarAcesso( '.$bolDocumentoRestrito.', '."'$strUrl'".' )">
                                      ...
                                      <img src="modulos/correios/imagens/png/download_arquivo_midia.png" title="download do arquivo para gravação em mídia" alt="Detalhar Objeto" class="infraImgAcoes" />
                                  </a>';
                    $strResultado .= '&nbsp;';
                }else {
                    $strResultado .= '<a class="protocoloNormal" href="' . $strUrlDocumento . '" target="_blank">
                                      <img style="margin-right:8px" src="modulos/correios/imagens/download_arquivo_midia.png" title="1 - download do arquivo para gravao em mdia" alt="Detalhar Objeto" class="infraImg" />
                                  </a>';
                }
            }
            $strResultado .= '</td></tr>' . "\n";
