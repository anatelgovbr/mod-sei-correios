...
try {
    ...
    if ($numRegistros > 0) {
        ...
        $strResultado .= '<th class="infraTh" width="250px">' . PaginaSEI::getInstance()->getThOrdenacao($objMdCorContratoDTO, 'Número do Contrato no Órgão', 'NumeroContrato', $arrObjMdCorContratoDTO) . '</th>' . "\n";
        $strResultado .= '<th class="infraTh">' . PaginaSEI::getInstance()->getThOrdenacao($objMdCorContratoDTO, 'Número do Contrato nos Correios', 'NumeroContratoCorreio', $arrObjMdCorContratoDTO) . '</th>' . "\n";
        ...
        for ($i = 0; $i < $numRegistros; $i++) {
            ...
            $strResultado .= '<td>' . PaginaSEI::tratarHTML($arrObjMdCorContratoDTO[$i]->getStrNumeroContratoCorreio()) . '</td>';
