...
include_once("md_cor_parametrizacao_rastreio_lista_css.php");
...
?>
    <form id="frmMdCorParametroRastreioCadastro" method="post" onsubmit="return OnSubmitForm();"
        ...
        <div class="row linha">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-lg-6 col-xl-6">
                        <label id="lblUsuario" for="txtUsuario" class="infraLabelObrigatorio">Usuário:
                            <img align="top" style="height:20px; width:20px;" id="imgAjuda" name="ajuda"
                                 src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg"
                                 onmouseover="return infraTooltipMostrar('Obtenha um Nome de Usuário válido para autenticação no SRO com o consultor comercial dos Correios que atende ao Contrato do Órgão.', 'Ajuda');"
                ...
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-lg-6 col-xl-6">
                        <label id="lblSenha" for="txtSenha" class="infraLabelObrigatorio">Senha:
                            <img align="top" style="height:20px; width:20px;" id="imgAjuda"
                                 ...
                                 onmouseover="return infraTooltipMostrar('A Senha de acesso ao SRO é fornecida junto com o Nome de Usuário para autenticação informado pelo consultor comercial dos Correios que atende ao Contrato do Órgão.', 'Ajuda');"
                                 onmouseout="return infraTooltipOcultar();"
                ...
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-lg-6 col-xl-6">
                        <label id="lblEnderecoWsdl" for="txtEnderecoWsdl" class="infraLabelObrigatorio">Endereço WSDL do
                            Web
                            Service do
                            SRO: <img align="top" style="height:20px; width:20px;"
                                      src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal(); ?>/ajuda.svg"
                                      name="ajuda"
                                      onmouseover="return infraTooltipMostrar('Obtenha o Endereço WSDL correto acessando o Manual do Web Service de Rastreamento de Objetos dos Correios.', 'Ajuda');"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button id="btnValidacao" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"
                                ...
                                <span class="infraTeclaAtalho">V</span>alidar<input name="hdnValidacao" value=""
                                                                                    type="hidden"
                                                                                    id="hdnValidacao"/>
                            </button>
                        </div>
