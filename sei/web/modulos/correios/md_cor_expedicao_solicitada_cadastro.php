        ...
        case 'md_cor_expedicao_solicitada_excluir':
            ...
            if (isset($_POST['txaJustificativa'])) {
                ...
                if ($dto->getNumIdUnidade() == SessaoSEI::getInstance()->getNumIdUnidadeAtual()) {
                    ...
                    $txtObservacoes = $dto->getStrObservacao();
...
//                $strLinkMontarArvore = SessaoSEI::getInstance()->assinarLink('controlador.php?acao=procedimento_trabalhar&acao_origem=' . $_GET['acao'] . '&acao_retorno=' . PaginaSEI::getInstance()->getAcaoRetorno() . '&id_procedimento=' . $objSaidaConsultarDocumentoAPI->getIdProcedimento() . '&id_documento=' . $_POST['hdnIdProcedimento']/* .'&id_procedimento_anexado='.$dblIdProcedimentoAnexado */);
            ...
            if (isset($_POST['txaObservacao'])) {
                try {
                    ...
                    if ($dto->getNumIdUnidade() == SessaoSEI::getInstance()->getNumIdUnidadeAtual()) {
                        ...
                        $dto->setStrObservacao($_POST['txaObservacao']);
                        $rn->alterar($dto);
        ...
        case 'md_cor_expedicao_solicitada_consultar':
            ...
            if (!is_null($dto->getNumIdUnidadeGeradora())) {

                $unidadeDTO = new UnidadeDTO();
                $unidadeDTO->retStrDescricao();
                $unidadeDTO->retStrSigla();
                $unidadeDTO->setNumIdUnidade($dto->getNumIdUnidadeGeradora());
...
if ($_GET['acao_origem'] != 'md_cor_expedicao_solicitada_cadastrar' && !isset($_POST['txaJustificativa'])) {
    ...
    <form id="frmSolicitarExpedicao" method="post" action="<?= $strAcaoForm ?>">
        ...
        <input type="hidden" id="hdnIdMdCorExpedicaoSolicitada" name="hdnIdMdCorExpedicaoSolicitada"
               value="<?php echo $idMdCorEexpedicaoSolicitada; ?>"/>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <?php if ($unidade_sol != '') { ?>
                            <label>
                                Unidade Solicitante: <?php echo $unidade_sol; ?>
                            </label>
                        <?php } ?>
                        ...
                        <?php if ($_GET['acao'] == 'md_cor_expedicao_solicitada_consultar') { ?>
                            <br/>
                            <label>
                                Unidade Expedidora: <?php echo $unidade_exp; ?>
                            </label>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <select class="infraSelect form-control" name="selServicoPostal" id="selServicoPostal"
                                tabindex="<?= PaginaSEI::getInstance()->getProxTabDados(); ?>">
                            <?php echo $strSelectServicoPostal; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <label class="infraLabelCheck" for="chkAvisoRecebimento">
                            <input type="checkbox" class="infraCheckbox form-control" id="chkAvisoRecebimento"
                                   name="chkAvisoRecebimento"
                                <?php echo $chkNecessitaRecebimentoAR; ?>
                                   tabindex="<?= PaginaSEI::getInstance()->getProxTabDados(); ?>"
                ...
                <div class="row rowFieldSet1 rowFieldSet">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <fieldset id="fieldDocumentosExpedidos" class="infraFieldset sizeFieldset form-control">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    ...
                                    <div>
                                        ...
                                        if ($tratamento_destinatario != '') {
                                            echo '<label name=lblGenero id=lblGenero class="infraLabelOpcional" >&nbsp;&nbsp;&nbsp;&nbsp;' . $tratamento_destinatario . '</label>';
                                        }
                                        ?>
                                        </br>
                                        ...
                                        if ($cargo_destinatario != '') {
                                            echo '<label name=lblCargo id=lblCargo class="infraLabelOpcional">&nbsp;&nbsp;&nbsp;&nbsp;' . $cargo_destinatario . '</label>';
                                        } ?>
                                        </br>
                                        <?php if ($nome_destinatario_associado != '') {
                                            echo '<label name=lblNomeAssociado id=lblNomeAssociado class="infraLabelOpcional">&nbsp;&nbsp;&nbsp;&nbsp;' . $nome_destinatario_associado . '</label>';
                                        }
                                        ?>
                                    </div>
                                </div>
        ...
        <div class="row rowFieldSet1 rowFieldSet">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <fieldset id="fieldFormatoDocumentos" class="infraFieldset sizeFieldset form-control">
                    <legend class="infraLegend">&nbspFormato de Expedição dos Documentos&nbsp</legend>

                    <table class="infraTable table" summary="Formato Expedição dos Documentos" id="tblFormatoExpedicao">
                        <thead>
                        <tr>
                            <th class="infraTh" align="center" style="display: none;" width="0">ID Documento</th>
                            <th class="infraTh" align="center" width="20%">Documento</th>
                            <th class="infraTh" align="center" width="37%">Formato da Expedição</th>
                            <th class="infraTh" align="center" width="36%">Impressão</th>
                            <th class="infraTh" align="center" width="13%">Justificativa</th>
                        </tr>
                        </thead>
                        <tbody>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
                                                        <div id="divRdoImpressao" class="infraDivRadio">
                                                            <div class="infraRadioDiv ">
                                                                <input id="rdoImpresso" <?php if ($formatoDTO->getStrFormaExpedicao() == MdCorExpedicaoFormatoRN::$TP_FORMATO_IMPRESSO) echo 'checked'; ?>
                                                                       value="<?php echo MdCorExpedicaoFormatoRN::$TP_FORMATO_IMPRESSO; ?>"
                                                                       type="radio" name="rdoFormato">
                                                                <label class="infraRadioLabel"
                                                                       for="rdoImpresso_"></label>
                                                            </div>
                                                            <label id="lblImpresso_" for="rdoImpresso_"
                                                                   class="infraLabelRadio"
                                                                   tabindex="507">Impresso</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                                                        <div id="divRdoGravacao" class="infraRadioDiv">
                                                            <input id="rdoMidia" <?php if ($formatoDTO->getStrFormaExpedicao() == MdCorExpedicaoFormatoRN::$TP_FORMATO_MIDIA) echo 'checked'; ?>
                                                                   value="<?php echo MdCorExpedicaoFormatoRN::$TP_FORMATO_MIDIA; ?>"
                                                                   type="radio" name="rdoFormato">
                                                            <label class="infraRadioLabel" for="rdoFormato_"></label>
                                                        </div>
                                                        <label id="lblImpresso_" for="rdoFormato_"
                                                               class="infraLabelRadio" tabindex="507">Gravação em
                                                            Mídia</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
                                                        <div id="divRdoImpressao" class="infraDivRadio">
                                                            <div class="infraRadioDiv ">
                                                                <input type="radio" name="rdoImpressao_' + id + '"
                                                                       id="rdoImpressao1_' + id + '"
                                                                       value="<?php echo MdCorExpedicaoFormatoRN::$TP_IMPRESSAO_PRETO_BRANCO; ?>"
                                                                       checked="checked"
                                                                       class="infraRadioInput"
                                                                       onclick="justificativaImprimir(this)">
                                                                <label class="infraRadioLabel"
                                                                       for="rdoImpressao1_' + id + '"></label>
                                                            </div>
                                                            <label id="lblImpressao_' + id + '"
                                                                   for="rdoImpressao1_' + id + '"
                                                                   class="infraLabelRadio" tabindex="507">Preto e
                                                                Branco</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                                                        <div id="divRdoGravacao" class="infraRadioDiv ">
                                                            <input type="radio" name="rdoImpressao_' + id + '"
                                                                   id="rdoImpressao2_' + id + '"
                                                                   value="<?php echo MdCorExpedicaoFormatoRN::$TP_IMPRESSAO_COLORIDO; ?>"
                                                                   class="infraRadioInput"
                                                                   onclick="justificativaImprimir(this)">
                                                            <label class="infraRadioLabel"
                                                                   for="rdoImpressao2_' + id + '"></label>
                                                        </div>
                                                        <label id="lblImpressao_' + id + '"
                                                               for="rdoImpressao2_' + id + '" class="infraLabelRadio"
        ...
        <div class="row" id="divProtocoloAnexo2">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <label for="txaObservacao" class="infraLabelOpcional">
                    Observação:
                </label>
                <textarea class="infraTextArea form-control" name="txaObservacao" id="txaObservacao" rows="3"
                          cols="150"
                          style="width: 100% !important; height: 70% !importan"
                          tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"><?php echo PaginaSEI::tratarHTML($txtObservacoes); ?></textarea>
            </div>
        </div>
        <div class="clear">&nbsp;</div>
        <? if ($_GET['acao'] != 'md_cor_expedicao_solicitada_cadastrar') : ?>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <textarea class="nfraTextArea form-control" name="txaJustificativa" id="txaJustificativa" rows="3"
                              cols="150"
