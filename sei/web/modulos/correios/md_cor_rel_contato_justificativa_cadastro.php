...
<form id="frmDestinatario" method="post" onsubmit="return OnSubmitForm();"
    ...
    <? if ($formAlterar) { ?>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <table class="infraTable" style="border: solid 1px; color: #DCDCDC;" cellspacing="0" cellpadding="5"
                       width="100%">
                    <tbody>
                    ...
                    <tr class="infraTrClara" style="width: 30px;">
                        ...
                        <td align="center">
                            <select id="selContatoJustificativa" name="selContatoJustificativa" class="infraSelect"
                                    style="width: 100%">
                ...
                <input type="hidden" id="hdnIdMdCorRelContJust" name="hdnIdMdCorRelContJust"
                       value="<?= $strIdMdCorRelContJust; ?>"/>
            </div>
        </div>
                ...
                <fieldset class="infraFieldset form-control" style="height: auto">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <label id="lblDestinatarios" for="txtDestinatarioNaoHabilitado" accesskey="e"
                                   class="infraLabelObrigatorio">
                                D<span class="infraTeclaAtalho">e</span>stinatários:
                            </label>

                            <input type="text" id="txtDestinatarioNaoHabilitado" name="txtDestinatarioNaoHabilitado"
                    ...
                    <div class="row">
                        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7">
                            <div class="input-group mb-3">
                                <select id="selDestinatarioNaoHabilitado" name="selDestinatarioNaoHabilitado"
                                        class="infraSelect"
                                        multiple="multiple"
                                        tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                ...
                                <div id="divOpcoesDestinatarios">
                                    <img id="imgSelecionarGrupo"
                                         onclick="objLupaDestinatarios.selecionar(700,500);"
                                         src="/infra_css/svg/pesquisar.svg"
                                         title="Selecionar Contatos para Destinatários"
                                         alt="Selecionar Contatos para Destinatários"
                                         class="infraImg"
                                         tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                                    <br/>

                                    <img id="imgRemoverDestinatarios"
                                         onclick="objLupaDestinatarios.remover();"
                                         src="/infra_css/svg/remover.svg"
                                         alt="Remover Destinatários Selecionados"
                                         title="Remover Destinatários Selecionados"
                                         class="infraImg"
                                         tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <label id="lblDestinatarioJustificativa" for="selDestinatarioJustificativa" accesskey=""
                                   class="infraLabelObrigatorio">Justifivativa:</label>
                            <div class="input-group mb-3">
                                <select id="selContatoJustificativa" name="selContatoJustificativa"
                                        class="infraSelect form-control">
                                    <?= $strItensSelJustificativa ?>
                                </select>
                                <input type="hidden" id="hdnDestinatarios" name="hdnDestinatarios"
                                       value="<?= PaginaSEI::tratarHTML($_POST['hdnDestinatarios']) ?>"/>
                                <input type="hidden" id="hdnIdDestinatarioNaoHabilitado"
                                       name="hdnIdDestinatarioNaoHabilitado"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-left">
                            <input type="button"
                                   ...
                                   id="sbmGravarEmail"
                                   name="sbmGravarEmail"
                                   onclick="transportarDestinatario();"
                                   tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"/>
                        </div>
                    </div>
                    <div id="divFieldset">
                        ...
                        <div id="tabelaDestinatario">
                            ...
                            <div id="divTabelaDestinatario" class="infraAreaTabela">
                                ...
                                <table id="tblDestinatarioNaoHabilitado" width="100%" class="infraTable">
                                    <tr>
                                        <th style="display:none;">IdContato</th>
                                        <th style="display:none;">IdJustificativa</th>
                                        <th class="infraTh" width="25%">Destinatário</th>
                                        <th class="infraTh" width="15%" align="left">Natureza</th>
                                        <th class="infraTh" width="15%" align="left">CPF/CNPJ</th>
                                        <th class="infraTh" width="45%" align="left">Justificativa</th>
                                        <th class="infraTh">Ações</th>
                                    </tr>
                                </table>

                                <input type="hidden" id="hdnTblDestinatarios" name="hdnTblDestinatarios"
                                       value="<?= $strDestinatarios; ?>"/>
                            </div>
                        </div>
                    </div>
                </fieldset>
