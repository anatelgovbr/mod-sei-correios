...
?>
    <form id="frmMdCorExtensaoMidiaCadastro" method="post" onsubmit="return OnSubmitForm();"
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-10 col-md-10 col-lg-8 col-xl-7">
                        <label id="lblPrincipal" for="txtPrincipal" accesskey="P" class="infraLabelObrigatorio">Extensões
                            Permitidas de Arquivos para Gravação em Mídia:</label>
                ...
                <div class="row">
                    <div class="col-sm-11 col-md-11 col-lg-9 col-xl-8">
        ...
        <input type="hidden" id="hdnIdMdCorExtensaoMidia" name="hdnIdMdCorExtensaoMidia"
               value=""/>
    </form>
<?
