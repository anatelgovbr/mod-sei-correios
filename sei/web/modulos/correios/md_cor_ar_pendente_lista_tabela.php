<?php
  ...
  $strResultado .= '<th class="infraTh" style="width: 70px  !important;">' . PaginaSEI::getInstance()->getThOrdenacao($mdCorExpedicaoSolicitadaDTO, 'Data da Solicitação', 'DataSolicitacao', $arrMdCorExpedicaoSolicitadaDTO) . '</th>';
  $strResultado .= '<th class="infraTh" style="width: 70px  !important;">' . PaginaSEI::getInstance()->getThOrdenacao($mdCorExpedicaoSolicitadaDTO, 'Data da Expedição', 'DataExpedicao', $arrMdCorExpedicaoSolicitadaDTO) . '</th>';

  $strResultado .= '<th class="infraTh" style="width: 70px  !important;">' . PaginaSEI::getInstance()->getThOrdenacao($mdCorExpedicaoSolicitadaDTO, 'Dias em Atraso', 'DataExpedicao', $arrMdCorExpedicaoSolicitadaDTO) . '</th>';
  $strResultado .= '<th class="infraTh" style="width: 140px  !important;">' . PaginaSEI::getInstance()->getThOrdenacao($mdCorExpedicaoSolicitadaDTO, 'Tipo de Atraso', 'NomeDestinatario', $arrMdCorExpedicaoSolicitadaDTO) . '</th>';
  $strResultado .= '<th class="infraTh" style="width: 140px  !important;">' . PaginaSEI::getInstance()->getThOrdenacao($mdCorExpedicaoSolicitadaDTO, 'Documento de Cobrança', 'ProtocoloFormatadoDocumento', $arrMdCorExpedicaoSolicitadaDTO) . '</th>';
  $strResultado .= '</tr>';
