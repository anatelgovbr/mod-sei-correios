...
class MdCorExpedicaoSolicitadaINT extends InfraINT {
  ...
  */
  ...
  /**
   * Metodo que recupera os dados das solicitacoes de expedicação pendentes que não tem nenhuma plp vinculado
   * @return montarSelectArrInfraDTO
   */
  ...
  public function montarQrCode($texto){
    ...
    public function montarQrCodeCorreio(MdCorExpedicaoSolicitadaDTO $objMdCorExpedicaoSolicitadaDTO){
        ...
        //Complemento do CEP: Número do logradouro.
        //Ex1: 00100
        //Ex2: 01200
        //Ex3: 00000 (Quando a informação for “S/N”, “BR 101”, “KM 5”)
        ...
        //IDV – Identificador de Dados Variáveis 51 - encomenda e 81 - Malotes
        $texto .= 51;

        //etiquetas
        $texto .= $objMdCorExpedicaoSolicitadaDTO->getStrCodigoRastreamento();

        //Serviços Adicionais - É obrigatório informar o código 25 de serviço adicional.
        ...
        //Informação de Agrupamento - não possui agrupamento
        $texto .= '00';

        //Número do Logradouro: Número do endereço(no SEI não possui)
        $texto .= '00000';

        //Complemento do Endereço: Informação adicional do endereço
        $texto .= $objMdCorExpedicaoSolicitadaDTO->getStrComplementoDestinatario();

        //Valor Declarado: Número inteiro - o produto não possui valor
        $texto .= '00000';

        //DDD + Telefone Destinatário: Número do telefone do destinatário - não possui na md_cor_contato
        $texto .= '000000000000';

        //Latitude: Resevado para futura implementação
        $texto .= '-00.000000';
        //Longitude: Resevado para futura implementação.
        $texto .= '-00.000000';
    ...
    /**
     * @description Função que irá validar se todos os itens do Destinatário estão preenchidos
     * @dataProvider 05-02-2021
     * @author Lino - Felipe Lino <felipe.silva@gt1tecnologia.com.br>
     * @param $idContato - Id do contato que estará querendo validar
     * @param false $bolEntrada - Caso não tenha sido chamada pelo botão "Solicitar Expedição" no Documento, esse parametro sempre será falso
     * @return string Será retornado uma string ou uma mensagem de alerta
     * @throws InfraException Caso tenha um erro na chamada Soap ele irá dar a exceção.
     */
...
// checar Natureza, Endereço, Bairro, Estado, Cidade, CEP
...
//se for pessoa fisica checar ainda: Gênero e Cargo
