    ...
    if (!is_null($objExpedSolicitacaoDTO)) {
        ...
        if (!is_null($arrObjMdCorExpAndamentoDTO)) {
            ...
            <div class="bloco" style="width: 100%; text-align: center;">
                <?php $nomeImg = $arrObjMdCorExpAndamentoDTO[0]->getStrNomeImagem() ? $arrObjMdCorExpAndamentoDTO[0]->getStrNomeImagem() : '';
                $caminhoImg = "modulos/correios/imagens/" . $nomeImg;
                ?>
            ...
            <div class="bloco" style="width: 100%;">
                ...
                <div style="width: 90%">
                    ...
                    foreach ($arrObjMdCorExpAndamentoDTO as $objDTO) {
                        ...
                        $objMdCorListaStatusDTO->setStrNomeImagem('', InfraDTO::$OPER_DIFERENTE);
                ...
                <div class="row">
                    <div class="bloco" style="width: 100%; text-align: center;">
                        <img class="imgRastreio"
                             src="<?php echo "modulos/correios/imagens/aguardando_postagem.png"; ?>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="bloco" style="width: 100%; text-align: center;">
